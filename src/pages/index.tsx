  ...
  return (
    <div className="flex space-x-2">
      <div>
        ...
        <Post
          id={1}
          postDesc="Hello Nayan Radadiya thaa is very helpful so all time grate so all time grate"
          postImage="post-img-1.png"
          userImage="profile-picture-5.jpg"
          userName="Nayan Radadiya"
          userStatus={true}
        />
        <Post
          id={2}
          postDesc="Hello Nayan Radadiya thaa is very helpful so all time grate so all time grate"
          postImage="user_3.jpeg"
          userImage="user_3.jpeg"
          userName="Ravi Savalya"
          userStatus={true}
        />
      </div>
